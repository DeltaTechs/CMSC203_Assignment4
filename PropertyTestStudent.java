...
class PropertyTestStudent {
	...
	void setUp() throws Exception {
		propertyOne = new Property("Property Tront", "Trontville", 6789.01, "Tronty Trontisson Television");
	}
	...
	void testGetPropertyName() {
		assertEquals("Property Tront", propertyOne.getPropertyName());
	}

	@Test
	void testGetRentAmount() {
		assertEquals(6789.01, propertyOne.getRentAmount());
	}
